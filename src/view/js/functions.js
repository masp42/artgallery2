        ...
        async function update() {
            ...
            dataForm.append('image', document.querySelector("#updateImage").value);
            dataForm.append('title', document.querySelector("#updateTitle").value);
            dataForm.append('description', document.querySelector("#updateDescription").value);
            dataForm.append('artist_name', document.querySelector("#updateArtistName").value);
            dataForm.append('artist_country', document.querySelector("#updateArtistCountry").value);
            dataForm.append('artist_period', document.querySelector("#updateArtistPeriod").value);
