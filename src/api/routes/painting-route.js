...
router.get('/:canvas_id', PaintingsController.getPaintingDetail); //http GET method to get one register by painting_id
router.post('/', PaintingsController.createPainting); //http POST method to insert data from form
router.put('/:canvas_id', PaintingsController.updatePainting); //http PUT method to update with data from form
router.delete('/:canvas_id', PaintingsController.deletePainting); //http DELETE method to remove one register by painting_id
